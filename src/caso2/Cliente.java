...
//						seguridad.setLlaveAsimetrica();
//						X509Certificate certificado = seguridad.crearCertificado();
//						// TODO Pues si...
//						/*
//						 * byte[] bytesCertiPem = certificado.; String certiString = new
//						 * String(Hex.toHexString(bytesCertiPem)); String certiFinal = certiString;
//						 */
...
//						System.out.println("Certificado digital del Servidor");
//						System.out.println(comando);
//						X509Certificate certiServi = seguridad.crearCertificado();
//						seguridad.setCertificado(certiServi);
//
//						System.out.println("CLIENTE: OK");
//						writer.println(OK);
